...
public class FileMonitor {
	...
	/*
	 * public static void main(String args[]) { // Create the monitor
	 * FileMonitor monitor = new FileMonitor(1000);
	 * 
	 * // Add some files to listen for monitor.addFile(new
	 * File("C:\\temp\\signal.txt"));
	 * 
	 * // Add a dummy listener monitor.addListener(new RawDataReader());
	 * 
