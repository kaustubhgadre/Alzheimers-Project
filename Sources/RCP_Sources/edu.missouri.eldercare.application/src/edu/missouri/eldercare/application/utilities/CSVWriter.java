...
public class CSVWriter implements Closeable {
    ...
    public void writeAll(List allLines)  {
    	for (Iterator iterator = allLines.iterator(); iterator.hasNext();) {
    ...
    public void writeNext(String[] nextLine) {
        ...
        for (int i = 0; i < nextLine.length; i++) {
            ...
            sb.append(stringContainsSpecialCharacters(nextElement) ? processLine(nextElement) : new StringBuilder(nextElement));
